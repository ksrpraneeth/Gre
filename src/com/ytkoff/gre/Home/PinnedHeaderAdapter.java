...
public class PinnedHeaderAdapter extends BaseAdapter implements
		OnScrollListener, IPinnedHeader, Filterable {
	...
	public PinnedHeaderAdapter(Context context, ArrayList<String> listItems,
			ArrayList<Integer> listSectionPos, HomeFragment homeFragment) {
		...
		if (convertView == null) {
			...
			case TYPE_SECTION:
				convertView = mLayoutInflater.inflate(
						R.layout.section_row_view, null);
				break;
			}
	...
	public Filter getFilter() {
		return (homeFragment).new ListFilter();
	}
